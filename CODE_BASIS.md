...
The empirical completion model estimates complete empty weight from core MTO and tank features. It does not alter engineering plate thickness.

Out-of-domain cases remain visibly marked REVIEW/SCREENING even when a numerical estimate is produced.
